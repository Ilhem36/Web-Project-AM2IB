...
session_start();
$annotator=$_SESSION["session_login"];//ici il faut modifier pour récupérer l'email annot quand il se logue donc il faut mettre juste post et ne pas changer la ligne suivanta.
