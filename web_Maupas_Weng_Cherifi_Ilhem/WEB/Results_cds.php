...
<div class ="container">
    ...
    <button class='btn btn--assign' onclick = "location.href = '<?php echo $url_ncbi;?>'"><br> NCBI </button>
    <button class='btn btn--assign' onclick = "location.href = '<?php echo $url_ensembl;?>'"><br> Ensembl </button>
    <button class='btn btn--assign' onclick = "location.href = '<?php echo $url_uniprot;?>'"><br> Uniprot </button>
    <br>
